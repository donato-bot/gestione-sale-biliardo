        ...
        <form onSubmit={handleSignUp} className="flex flex-col gap-4">
          <div>
            ...
            <input 
              ...
              className="w-full border border-gray-600 bg-gray-700 p-3 rounded text-white focus:ring-2 focus:ring-blue-500 outline-none"
              required 
            />
          </div>
          ...
          <button 
            type="submit" 
            disabled={loading}
            className={`w-full mt-4 p-3 rounded font-bold transition-colors ${
