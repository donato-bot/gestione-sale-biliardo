...
// OBIETTIVO: Gestione Inventario, Bar, Scorte e Stampa PDF
// ==========================================
...
export default function MagazzinoBar() {
  ...
  // Funzione per attivare la stampa/salvataggio PDF
  ...
  return (
    <div className="min-h-screen bg-[#050505] p-6 print:bg-white print:p-0 relative">
      ...
      {/* Rimuoviamo la griglia durante la stampa per permettere alla tabella di espandersi */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-7xl print:block">
        
        {/* COLONNA INSERIMENTO (Nascondiamo in stampa con print:hidden) */}
          ...
          <form onSubmit={aggiungiProdotto} className="space-y-4">
            <div>
              ...
              <input 
                type="text" 
                required
                placeholder="Es. Coca Cola in vetro"
                value={nomeProdotto}
            ...
            <div>
              ...
              <input 
                type="text" 
                placeholder="Es. Bibite, Snack, Amari..."
                value={categoria}
