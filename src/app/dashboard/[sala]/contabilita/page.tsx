...
// OBIETTIVO: Libro Mastro - Lettura sospesi, Riscossione crediti ed Esportazione PDF
// ==========================================
...
export default function LibroMastro() {
  ...
  // Funzione per attivare la stampa/salvataggio PDF nativo
  ...
  return (
    <div className="min-h-screen bg-[#050505] p-6 print:bg-white print:p-0 relative">
      <header className="mb-8 border-b border-gray-800 print:border-black pb-4 flex justify-between items-end">
        ...
        {/* SEZIONE DESTRA: TOTALI E PULSANTE STAMPA */}
