  ...
  return (
    <div className="min-h-screen bg-[#05070a] text-white font-sans selection:bg-cyan-500/30 flex justify-center p-4 sm:p-8">
      <div className="bg-[#0b0d14] w-full max-w-[1800px] min-h-[800px] rounded-[2rem] border border-gray-800/50 shadow-[0_0_50px_rgba(0,0,0,0.5)] overflow-hidden animate-in fade-in duration-300 p-6 sm:p-10">
        ...
        {/* Mappatura sezioni - Pulita dai parametri superflui */}
        ...
        {sezioneAttiva === "soci" && <Soci salaId={params.sala} />}
        {sezioneAttiva === "magazzino" && <Magazzino salaId={params.sala} />}
        {sezioneAttiva === "report" && <Report salaId={params.sala} />}
        {sezioneAttiva === "prenotazioni" && <Prenotazioni salaId={params.sala} />}
        ...
        {sezioneAttiva === "servizi" && <Servizi salaId={params.sala} />}
        {sezioneAttiva === "manuale" && <ManualeOperativo salaId={params.sala} />}
      </div>
    </div>
  );
}